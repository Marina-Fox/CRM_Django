...
from .views import AdvertisementList, AdvertisementCreate
...
urlpatterns = [
    ...
    # path("<int:pk>/", ServicesDetail.as_view(), name="ad_detail"),
    # path("<int:pk>/edit/", ServicesUpdate.as_view(), name="ad_update"),
